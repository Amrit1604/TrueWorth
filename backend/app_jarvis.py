...
if __name__ == '__main__':
    print("=" * 60)
    print("⚡ JARVIS TURBO MODE - PRICE INTELLIGENCE PLATFORM")
    print("=" * 60)
    print(f"📊 Platforms: {', '.join(scraper_manager.get_available_platforms())}")
    print(f"⚡ Max Workers: {scraper_manager.max_workers} (TURBO)")
    print(f"💾 Cache TTL: {scraper_manager.cache_ttl}s (AGGRESSIVE)")
    print(f"🛡️  Safety: Rate limiting, minimal delays, TURBO enabled")
    print(f"⚡ SPEED: Images disabled, 15s page load, 20s platform timeout")
    print(f"⚡ MODE: 5 products/platform for speed + reliability")
    print("=" * 60)
